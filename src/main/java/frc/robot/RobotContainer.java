  ...
  */
  ...
  private void configureButtonBindings() {
    ...
    //  yTrigger.onTrue(mOpenArmSlowForResetCommand);
     ...
     operateCommandJoystick.button(X).onTrue(mLiftSubsystem.ArmToAngleCommand(0));
     operateCommandJoystick.button(A).onTrue(mLiftSubsystem.ArmToAngleCommand(-0.313));
     operateCommandJoystick.button(B).onTrue(mLiftSubsystem.ArmToAngleCommand(1));
